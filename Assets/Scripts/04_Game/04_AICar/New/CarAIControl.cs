...
//        [SerializeField] private float m_RandomPerlin;             // AI車がランダムにふらつくためのPerlinノイズ値
//        //private CarController m_CarController;    // 操作対象のCarControllerの参照
//        private AICarControll m_CarControll;
//        [SerializeField] private float m_AvoidOtherCarTime;        // 直前に衝突した車を回避するための時間
//        [SerializeField] private float m_AvoidOtherCarSlowdown;    // 衝突を回避するために減速する割合
//        [SerializeField] private float m_AvoidPathOffset;          // 進行方向に対して回避のために左右どちらにオフセットするか
...
namespace UnityStandardAssets.Vehicles.Car
{
    [RequireComponent(typeof(AICarControll))]
    public class CarAIControl : MonoBehaviour
    {
        public enum BrakeCondition
        {
        ...
        private AICarControll m_CarController;    // Reference to actual car controller we are controlling
        ...
        private void Awake()
        {
            ...
            m_CarController = GetComponent<AICarControll>();
